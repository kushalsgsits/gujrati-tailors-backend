...
public class ItemService {
    ...
    static {
        ...
        ITEMS.add(new Item("suit2p", "2 Piece Suit", 4000, ItemGroup.COAT, ItemType.COMBO,
                        List.of("blazerOrCoat", "pant", "shirt")));
        ITEMS.add(new Item("suit3p", "3 Piece Suit", 5000, ItemGroup.COAT, ItemType.COMBO,
                        List.of("blazerOrCoat", "pant", "waistCoat", "shirt")));
        ITEMS.add(new Item("jodhpuriSuit", "Jodhpuri Suit", 4000, ItemGroup.COAT, ItemType.COMBO,
                        List.of("blazerOrCoat", "pant")));
        ITEMS.add(new Item("achkan", "Achkan/Sherwani", 5000, ItemGroup.COAT, ItemType.COAT));
        ITEMS.add(new Item("indoWesternSet", "Indo Western Set", 5000, ItemGroup.COAT, ItemType.COMBO,
            List.of("achkan", "jacket", "pantPayjama")));

        ITEMS.add(new Item("shirtPant", "Shirt-Pant", 900, ItemGroup.SHIRT_PANT, ItemType.COMBO,
                        List.of("shirt", "pant")));
        ...
        ITEMS.add(new Item("kurtaPant", "Kurta-Pant", 850, ItemGroup.KURTA_PAYJAMA, ItemType.COMBO,
                        List.of("kurta", "pantPayjama")));
        ITEMS.add(new Item("kurtaPayjama", "Kurta-Payjama", 800, ItemGroup.KURTA_PAYJAMA, ItemType.COMBO,
        ...
        ITEMS.add(new Item("pathaniSuit", "Pathani Suit", 1000, ItemGroup.KURTA_PAYJAMA, ItemType.COMBO,
                        List.of("kurta", "payjama")));
        ...
        ITEMS.add(new Item("safariShirt", "Safari Shirt", 700, ItemGroup.MISCELLANEOUS, ItemType.SAFARI_SHIRT));
        ITEMS.add(new Item("safariSuit", "Safari Suit", 1200, ItemGroup.MISCELLANEOUS, ItemType.COMBO,
                        List.of("safariShirt", "pant")));
        ITEMS.add(new Item("accessories", "Accessories", 1, ItemGroup.MISCELLANEOUS, ItemType.ACCESSORIES));
